...
export const translations = {
  EN: {
    ...
    terms: {
      ...
      subtitle: 'Please read these terms carefully before using SayTruth.',
      updated: 'Last updated: February 6, 2026',
      back: 'Back',
      sections: {
      ...
      body: {
        acceptance: 'By using SayTruth, you agree to these Terms & Conditions. If you do not agree, please do not use the service.',
        usage: 'Do not misuse the service, attempt to access data you are not authorized to access, or harm other users.',
        content: 'You are responsible for the content you submit. We may remove content that violates our policies.',
        privacy: 'We value privacy. Use strong credentials and keep your secret answers safe.',
        changes: 'We may update these terms from time to time. Continued use means you accept the updated terms.',
      }
    },
    ...
    profile: {
      ...
      bioPlaceholder: 'Add a short bio about yourself... (links are clickable)',
      editBio: 'Edit bio',
    ...
    links: {
      ...
      duration7d: '1 week',
      duration30d: '1 month',
      guestDurationNote: 'Longer durations are available after login.',
    ...
    settings: {
      ...
      usernameHint: 'Letters, numbers, and underscores only (3-50 characters)',
      saveUsername: 'Save username',
      usernameUpdated: 'Username changed successfully',
      usernameTaken: 'Username already taken',
      usernameSame: 'New username is the same as your current one',
      // Change password / security
      securitySection: 'Security',
      changeSecurityPhrase: 'Change secret phrase',
      currentQuestion: 'Your current secret question',
      oldAnswer: 'Current answer',
      oldAnswerPlaceholder: 'Enter your current answer',
      newPhrase: 'New secret question',
      newPhrasePlaceholder: 'e.g., "What is your pet\'s name?"',
      newAnswer: 'New answer',
      newAnswerPlaceholder: 'Enter your new answer',
      confirmNewAnswer: 'Confirm new answer',
      confirmNewAnswerPlaceholder: 'Re-enter your new answer',
      updateSecurity: 'Update security phrase',
      answersMismatch: 'New answers do not match',
      securityUpdated: 'Security phrase updated successfully',
      wrongAnswer: 'Current answer is incorrect',
      allFieldsRequired: 'All fields are required',
      // Google
      googleSection: 'Google Account',
      linkGoogle: 'Link Google Account',
      googleLinked: 'Google account linked',
      googleLinkedAs: 'Linked as',
      unlinkGoogle: 'Google is linked to your account',
      googleLinkSuccess: 'Google account linked successfully',
      googleAlreadyLinked: 'This Google account is linked to another user',
      resetViaGoogle: 'Reset security phrase via Google',
      resetViaGoogleDesc: 'Use your linked Google account to reset your secret phrase without knowing the old answer',
      googleNotLinked: 'Link a Google account first to use this feature',
    },
  ...
  AR: {
    ...
    terms: {
      ...
      subtitle: 'يرجى قراءة الشروط بعناية قبل استخدام SayTruth.',
      updated: 'آخر تحديث: 6 فبراير 2026',
      back: 'رجوع',
      sections: {
      ...
      body: {
        acceptance: 'باستخدام SayTruth فإنك توافق على هذه الشروط والأحكام. إذا لم توافق، يرجى عدم استخدام الخدمة.',
        usage: 'لا تسيء استخدام الخدمة أو تحاول الوصول إلى بيانات غير مصرح بها أو تضر المستخدمين الآخرين.',
        content: 'أنت مسؤول عن المحتوى الذي ترسله. قد نزيل المحتوى المخالف لسياساتنا.',
        privacy: 'نحن نقدر الخصوصية. استخدم بيانات قوية واحفظ إجاباتك السرية بأمان.',
        changes: 'قد نقوم بتحديث هذه الشروط من وقت لآخر. استمرارك في الاستخدام يعني قبولك للتحديثات.',
      }
    },
    ...
    profile: {
      ...
      bioPlaceholder: 'أضف نبذة قصيرة عنك... (الروابط قابلة للنقر)',
    ...
    links: {
      ...
      guestDurationNote: 'المدد الأطول متاحة بعد تسجيل الدخول.',
    ...
    settings: {
      ...
      usernameHint: 'أحرف وأرقام وشرطات سفلية فقط (3-50 حرفًا)',
      saveUsername: 'حفظ اسم المستخدم',
      usernameUpdated: 'تم تغيير اسم المستخدم بنجاح',
      usernameTaken: 'اسم المستخدم مستخدم بالفعل',
      usernameSame: 'اسم المستخدم الجديد هو نفس الحالي',
      // Change password / security
      securitySection: 'الأمان',
      changeSecurityPhrase: 'تغيير العبارة السرية',
      currentQuestion: 'سؤالك السري الحالي',
      oldAnswer: 'الإجابة الحالية',
      oldAnswerPlaceholder: 'أدخل إجابتك الحالية',
      newPhrase: 'السؤال السري الجديد',
      newPhrasePlaceholder: 'مثال: "ما اسم حيوانك الأليف؟"',
      newAnswer: 'الإجابة الجديدة',
      newAnswerPlaceholder: 'أدخل إجابتك الجديدة',
      confirmNewAnswer: 'تأكيد الإجابة الجديدة',
      confirmNewAnswerPlaceholder: 'أعد إدخال إجابتك الجديدة',
      updateSecurity: 'تحديث العبارة السرية',
      answersMismatch: 'الإجابات الجديدة غير متطابقة',
      securityUpdated: 'تم تحديث العبارة السرية بنجاح',
      wrongAnswer: 'الإجابة الحالية غير صحيحة',
      allFieldsRequired: 'جميع الحقول مطلوبة',
      // Google
      googleSection: 'حساب جوجل',
      linkGoogle: 'ربط حساب جوجل',
      googleLinked: 'حساب جوجل مرتبط',
      googleLinkedAs: 'مرتبط بـ',
      unlinkGoogle: 'جوجل مرتبط بحسابك',
      googleLinkSuccess: 'تم ربط حساب جوجل بنجاح',
      googleAlreadyLinked: 'هذا الحساب مرتبط بمستخدم آخر',
      resetViaGoogle: 'إعادة تعيين العبارة السرية عبر جوجل',
      resetViaGoogleDesc: 'استخدم حساب جوجل المرتبط لإعادة تعيين العبارة السرية',
      googleNotLinked: 'اربط حساب جوجل أولاً لاستخدام هذه الميزة',
    },
  ...
  ES: {
    ...
    terms: {
      ...
      subtitle: 'Lee estos términos cuidadosamente antes de usar SayTruth.',
      updated: 'Última actualización: 6 de febrero de 2026',
      back: 'Volver',
      sections: {
      ...
      body: {
        acceptance: 'Al usar SayTruth, aceptas estos Términos y Condiciones. Si no estás de acuerdo, no uses el servicio.',
        usage: 'No hagas un uso indebido del servicio ni intentes acceder a datos no autorizados.',
        content: 'Eres responsable del contenido que envías. Podemos eliminar contenido que viole nuestras políticas.',
        privacy: 'Valoramos la privacidad. Usa credenciales seguras y protege tus respuestas secretas.',
        changes: 'Podemos actualizar estos términos ocasionalmente. El uso continuo implica aceptación.',
      }
    },
    ...
    profile: {
      ...
      bioPlaceholder: 'Agrega una biografía corta... (los enlaces son clicables)',
      editBio: 'Editar bio',
    ...
    links: {
      ...
      duration7d: '1 semana',
      duration30d: '1 mes',
      guestDurationNote: 'Las duraciones más largas están disponibles después de iniciar sesión.',
    ...
    settings: {
      ...
      newUsernamePlaceholder: 'Ingresa el nuevo nombre de usuario',
      usernameHint: 'Solo letras, números y guiones bajos (3-50 caracteres)',
      saveUsername: 'Guardar nombre de usuario',
      usernameUpdated: 'Nombre de usuario cambiado correctamente',
      usernameTaken: 'El nombre de usuario ya está en uso',
      usernameSame: 'El nuevo nombre de usuario es igual al actual',
      // Change password / security
      securitySection: 'Seguridad',
      changeSecurityPhrase: 'Cambiar frase secreta',
      currentQuestion: 'Tu pregunta secreta actual',
      oldAnswer: 'Respuesta actual',
      oldAnswerPlaceholder: 'Ingresa tu respuesta actual',
      newPhrase: 'Nueva pregunta secreta',
      newPhrasePlaceholder: 'ej. "¿Cómo se llama tu mascota?"',
      newAnswer: 'Nueva respuesta',
      newAnswerPlaceholder: 'Ingresa tu nueva respuesta',
      confirmNewAnswer: 'Confirmar nueva respuesta',
      confirmNewAnswerPlaceholder: 'Re-ingresa tu nueva respuesta',
      updateSecurity: 'Actualizar frase secreta',
      answersMismatch: 'Las nuevas respuestas no coinciden',
      securityUpdated: 'Frase secreta actualizada correctamente',
      wrongAnswer: 'La respuesta actual es incorrecta',
      allFieldsRequired: 'Todos los campos son obligatorios',
      // Google
      googleSection: 'Cuenta de Google',
      linkGoogle: 'Vincular cuenta de Google',
      googleLinked: 'Cuenta de Google vinculada',
      googleLinkedAs: 'Vinculado como',
      unlinkGoogle: 'Google está vinculado a tu cuenta',
      googleLinkSuccess: 'Cuenta de Google vinculada correctamente',
      googleAlreadyLinked: 'Esta cuenta de Google está vinculada a otro usuario',
      resetViaGoogle: 'Restablecer frase secreta con Google',
      resetViaGoogleDesc: 'Usa tu cuenta de Google vinculada para restablecer tu frase secreta sin la respuesta anterior',
      googleNotLinked: 'Vincula una cuenta de Google primero para usar esta función',
    },

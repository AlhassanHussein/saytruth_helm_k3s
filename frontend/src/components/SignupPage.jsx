...
const SignupPage = ({ onSignupSuccess }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Notify App that signup succeeded (sets auth state + fetches currentUser)
      if (onSignupSuccess) {
        onSignupSuccess();
      }
    } catch (err) {
        ...
        <form className="auth-form" onSubmit={handleSubmit}>
          ...
          <div className="form-group">
            <div className="label-row">
              <label className="label" htmlFor="signup-username">{common.username}</label>
          ...
          <div className="form-group">
            <div className="label-row">
              <label className="label" htmlFor="signup-name">{common.name}</label>
          ...
          <div className="form-group">
            ...
            <div className="input-with-toggle">
              <input
                ...
                placeholder={t.confirmAnswerPlaceholder}
                dir={isRTL ? 'rtl' : 'ltr'}
              />
              <button
                type="button"
